...
- [x] The Upper Yellow River archive contains the 16 verified stations and excludes Xiaheyan because of the coordinate mismatch.
- [x] The archived Upper Yellow River inputs match the exact 2010-01-01 to 2024-03-31 analysis period.
...
- [x] The Methods and Supplementary Information describe how released data/software map to the main and external-basin analyses.

## Basic Verification

- [x] `python scripts/check_package.py` passes.
- [x] Upper Yellow River preparation/unit checks pass (6 tests).
- [x] Formal Upper Yellow River GPU run completes and archived outputs pass structural checks.
- [ ] Clean-environment smoke run completes:
